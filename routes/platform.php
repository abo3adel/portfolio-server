...
Route::screen("example-layouts", ExampleLayoutsScreen::class)->name(
    "platform.example.layouts"
);
Route::screen("example-charts", ExampleChartsScreen::class)->name(
    "platform.example.charts"
);
Route::screen("example-editors", ExampleTextEditorsScreen::class)->name(
    "platform.example.editors"
);
Route::screen("example-cards", ExampleCardsScreen::class)->name(
...
Route::screen("posts/{post}/edit", CreateScreen::class)->name(
    "admin.post.edit"
);
