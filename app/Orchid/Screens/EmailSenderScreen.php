...
class EmailSenderScreen extends Screen
{
        ...
        return [
            Layout::rows([
                ...
                Relation::make("users.")
                    ...
                    ->help(
                        "Enter the users that you would like to send this message to."
                    )
                ...
                Quill::make("content")
                    ...
                    ->help(
                        "Add the content for the message that you would like to send."
                    ),
            ]),
        ];
    }
    ...
    public function sendMessage(Request $request)
    {
        ...
        Mail::raw($request->get("content"), function (Message $message) use (
            $request
        ) {
